    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-950 to-blue-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm sm:max-w-md">
        ...
        <motion.div
          ...
          className="bg-gray-800/50 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 border border-purple-500/20 shadow-2xl"
        >
          <div className="text-center mb-6 md:mb-8">
            <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">Welcome Back!</h1>
            <p className="text-gray-400 text-sm md:text-base">Sign in to continue creating viral content</p>
          </div>
          ...
          <div className="relative mb-6 md:mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gray-800 text-gray-400 text-xs md:text-sm">Or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
            ...
            >
              ...
              <Link href="/forgot-password" className="text-sm text-purple-400 hover:text-purple-300 transition-colors duration-300 hover:underline">
                Forgot password?
              </Link>
            </motion.div>
